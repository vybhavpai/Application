...
//    ArrayList<TagClass> tagObjList = new ArrayList<>();
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if(id == R.id.myprof){
                    ...
                    Toast.makeText(HomePageStudent.this, "Location", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(HomePageStudent.this, MapTemp.class);
                    startActivity(intent);
                }
                return true;
            }
    ...
    private void readData(View view)
    {
        ...
        final HomePageStudent.Adapter adapter=new HomePageStudent.Adapter();
...
//                        profileTagObj.tagObj = tagObjList.get(position);
                        ...
                        ///Toast.makeText(HomePageStudent.this, "hello", Toast.LENGTH_SHORT).show();
                        startActivity(intent);
